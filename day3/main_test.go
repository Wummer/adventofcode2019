...
func TestSolution1(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			actualDistance, actualSteps := ClosestIntersection(coordinatesWire1, coordinatesWire2)
			assert.Equal(t, test.expectedDistance, actualDistance)
			assert.Equal(t, test.expectedSteps, actualSteps)
		})
	}
}
